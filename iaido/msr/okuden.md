...
The name Kasumi may have borrowed from the *Soto no mono no daiji*, where it describes a detached, "dreamlike" state of mind, as if one is "seeing through a haze". That Kasumi, however, is unrelated to this kata, which was originally called Mukōbarai and is first attested in the *Battō kokoromochi no koto*.
