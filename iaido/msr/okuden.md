...
There is, however, one entry in the copy of the *Soto no mono no daiji* written by the tenth headmaster Hayashi Yasudayū Masakusu, where the following is explicitly stated under the heading 詰合ハ二星 ("*[Tsumeai](README.md#tsumeai-no-kurai)* (is) *nisei*"):
